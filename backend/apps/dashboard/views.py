...
def kpi_drilldown_view(request):
    """
    BUG FIX PRINCIPAL: Ahora usa select_related('paciente') y el template
    accede a los atributos correctos del modelo RegistroClinico.
    Todos los filtros son consistentes con KPICalculator.
    """
