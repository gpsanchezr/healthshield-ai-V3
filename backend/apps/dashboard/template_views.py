...
def consulta_medica_page(request):
    """Consultorio virtual del médico — visualizar pacientes y registrar consultas."""
    return render(request, 'consulta_medica/index.html')
