...
from apps.dashboard.template_views import (
    login_page, dashboard_page, etl_page, pacientes_page, admision_page,
    ml_page, reportes_page, alertas_page, ml_monitor_page,
    paciente_detail_page, analytics_page, consulta_medica_page,
)
...
urlpatterns = [
    ...
    # Admisión: solo admin y analista (NO médico)
    path('admision/',      admision_page,       name='admision'),
    path('pacientes/nuevo/', RedirectView.as_view(url='/admision/'), name='paciente-nuevo'),

    # Consulta Médica: solo médico
    path('consulta/',      consulta_medica_page, name='consulta-medica'),
