...
# ── CORS para producción (Render / Railway) ────────────────────────────────────
# Acepta el dominio propio del servicio en la nube + localhost para pruebas
CORS_ALLOWED_ORIGINS = env(
    'CORS_ALLOWED_ORIGINS',
    'http://localhost:8000,http://localhost:3000'
).split(',')
# También permitir cualquier subdominio de onrender.com y railway.app
...
# Usa el mismo Redis que Celery (ya configurado arriba)
CHANNEL_LAYERS = {
    "default": {
