...
# InMemoryChannelLayer para desarrollo. En producción se sobreescribe con Redis.
CHANNEL_LAYERS = {
    "default": {
...
CORS_ALLOWED_ORIGINS = env('CORS_ALLOWED_ORIGINS','http://localhost:3000,http://localhost:8080,http://localhost:8000').split(',')
