...
| Base de datos | PostgreSQL 16 con Render en la nube  y MySQL con Xampp de forma local  / SQLite (dev) | - |
...
# Resultado esperado: 24/24 tests PASADOS ✅
```
...
│
├── tests/
│   ├── run_tests.py               # 24 tests ETL + ML (sin BD)
│   ├── test_etl.py
│   ├── test_ml.py
...
- ✅ **WebSockets reales** — Django Channels + Daphne ASGI; alertas en tiempo real sin polling
